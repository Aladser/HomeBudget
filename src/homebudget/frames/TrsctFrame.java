...
public class TrsctFrame extends javax.swing.JFrame {
    ...
    public TrsctFrame(homebudget.HomeBudget launcher) throws SQLException {
        ...
        // дата
        startDateTxtBox.setFocusable(false);
        finalDateTxtBox.setFocusable(false);
        updateData();
    }
    ...
    private void updateData() throws SQLException{
        ...
        switch(timeGapPrdBox.getSelectedIndex()){
            case 1:
            ...
            // все время
            case 2:
                startDate.setTime(launcher.TRSCTS.getFirstRecordDate());
                setDateEditable(false);
                break;
            // вручную
            case 3:
        ...
        startDateTxtBox.setText(dateFormat.format(startDate.getTime()));
        // вторая дата периода е
        long finalDateMS = new Date().getTime() + 86400000;
        finalDate = new Date();
        ...
        if( timeGapPrdBox.getSelectedIndex()==2 )
            ...
            table.setModel( new TransactionsTableModel(launcher.TRSCTS.getData(startDate.getTime(), finalDate)));
    ...
    // установка разрешения ввода даты
    private void setDateEditable(boolean val){
        startDateTxtBox.setFocusable(val);
        finalDateTxtBox.setFocusable(val);
    }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(finalDateTxtBox, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(startDateTxtBox, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
